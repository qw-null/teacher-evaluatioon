...
export default {
  ...
  methods: {
    Login () {
      var url = 'http://58.119.112.14:11029/login';
...
.bevel {
  ...
  text-shadow: -1px -1px 1px #000, 0 -1px 1px #000, 1px -1px 1px #000,
    1px 0 1px #000, 1px 1px 1px #000, 0 1px 1px #000, -1px 1px 1px #000,
    -1px 0 1px #000, 0 0 4px #000;
}
.bevel,
.bevel:after {
  -webkit-filter: url(#light2);
  filter: url(#light2);
}
.bevel:after {
  content: '';
