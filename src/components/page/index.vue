<template>
  <div style="margin-left: 8px;margin-right: 8px">
    ...
    <div style="width: 100%">
      <div class="title2">
        <span style="font-size: 14px;color: #66b1ff;font-weight: bold">{{this.stuName}}</span>同学！请完成下列评价。需要完成<span style="font-size: 14px;color: red;font-weight: bold">{{this.len+1}}</span>条评价，已完成<span style="font-size: 14px;color: red;font-weight: bold">{{this.len1}}</span>条,未完成<span style="font-size: 14px;color: red;font-weight: bold">{{this.len+1-this.len1}}</span>条</div>
      <div class="line"></div>
      <alert v-model="visible2" :title="'你已完成全部评价'">{{'谢谢你的参与!'}}</alert>
      <!--<el-popover-->
        <!--placement="top"-->
        <!--width="160"-->
        <!--v-model="visible2">-->
      ...
      <el-table
        ...
        <el-table-column
          ...
          style="width: 50%">
          <template slot-scope="scope">
            <el-button @click="handleClick(scope.row)" type="primary" size="small" v-if="scope.row.flag===0">点击评价</el-button>
            <el-button type="primary"  size="small" style="margin-left: 10px" v-if="scope.row.flag===1" disabled>已评价</el-button>
      ...
      <!--<el-table-->
        ...
        <!--</el-table-column>-->
      <!--</el-table>-->
      <div style="width: 80%; margin: 20px auto;" v-show="flag1">
        <el-row>
          <el-col :span="12">
            <el-select v-model="value" placeholder="请选择体育老师" style="width: 100%;" size="small" @change="getCode()" v-if="flag2">
              <el-option
          ...
          <el-col :span="8">
            <div v-if="flag3" style="width: 100%;margin-left: 10%;font-size: 14px;color: gray">{{this.value}}</div>
          </el-col>
          <el-col :span="8">
            <div v-if="flag3" style="width: 100%;margin-left: 10%;font-size: 14px;color: gray">{{this.teaClass}}</div>
          </el-col>
          <el-col :span="8">
            <el-button @click="gymClick" type="primary" size="small" style="margin-left: 60%" v-if="flag1">点击评价</el-button>
            <el-button type="primary"  size="small" style="margin-left: 25%" v-else="flag1"  disabled>已评价</el-button>
          </el-col>
        </el-row>
    ...
    <div style="width: 80%;">
      <el-button type="primary" v-if="worked" @click="workedsee=true" size="small" style="margin-left: 45%;margin-bottom: 30px;margin-top: 30px">已全部评完</el-button>
      <alert v-model="workedsee" content="休息，休息一下吧！"></alert>
    </div>
              ...
              <div style="margin-top: 20px">
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.one_score" label="A">A.教书育人，师德高尚</el-radio>
                  </el-tag>
                </div>
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.one_score" label="B">B.有责任心，关爱学生</el-radio>
                  </el-tag>
                </div>
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.one_score" label="C">C.有一定的责任心</el-radio>
                  </el-tag>
                </div>
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.one_score" label="D">D.工作敷衍，缺少爱心</el-radio>
                  </el-tag>
                </div>
              </div>
            </div>
          ...
          <el-form-item prop="two_score">
            <div style="margin-bottom: 20px">
              ...
              <div style="margin-top: 20px">
                ...
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.two_score" label="A">A.科学准确，逻辑清晰，重能力培养</el-radio>
                  </el-tag>
                </div>
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.two_score" label="B">B.科学正确，有重点，有一定深广度</el-radio>
                  </el-tag>
                </div>
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.two_score" label="C">C.重点有时不突出，深广度不足</el-radio>
                  </el-tag>
                </div>
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.two_score" label="D">D.讲授不清晰，内容浅，容量小</el-radio>
                  </el-tag>
                </div>
          ...
          <el-form-item prop="three_score">
            <div style="margin-bottom: 20px">
              ...
              <div style="margin-top: 20px">
                ...
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.three_score" label="A">A.方法生动多样，关注学生需求</el-radio>
                  </el-tag>
                </div>
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.three_score" label="B">B.方法比较灵活，能够激发兴趣</el-radio>
                  </el-tag>
                </div>
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.three_score" label="C">C.方法单一，不太灵活</el-radio>
                  </el-tag>
                </div>
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.three_score" label="D">D.不关注学生，灌输式教学</el-radio>
                  </el-tag>
                </div>
          ...
          <el-form-item prop="four_score">
            <div style="margin-bottom: 20px">
              ...
              <div style="margin-top: 20px">
                ...
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.four_score" label="A">A.氛围好，学习收获很大</el-radio>
                  </el-tag>
                </div>
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.four_score" label="B">B.氛围较好，学习收获较大</el-radio>
                  </el-tag>
                </div>
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.four_score" label="C">C.氛围一般，有一定收获</el-radio>
                  </el-tag>
                </div>
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.four_score" label="D">D.秩序欠佳，学习收获不大</el-radio>
                  </el-tag>
                </div>
          ...
          <el-form-item prop="five_score">
            <div style="margin-bottom: 20px">
              ...
              <div style="margin-top: 20px">
                ...
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.five_score" label="A">A.精心布置，认真批改，有效反馈</el-radio>
                  </el-tag>
                </div>
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.five_score" label="B">B.作业适量，及时批改反馈</el-radio>
                  </el-tag>
                </div>
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.five_score" label="C">C.作业基本适量，能够批改反馈</el-radio>
                  </el-tag>
                </div>
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.five_score" label="D">D.作业不适量、低效，批改不认真</el-radio>
                  </el-tag>
                </div>
          ...
          <el-form-item prop="six_score">
            <div style="margin-bottom: 20px">
              ...
              <div style="margin-top: 20px">
                ...
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.six_score" label="A">A.认真答疑，辅导针对性强</el-radio>
                  </el-tag>
                </div>
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.six_score" label="B">B.经常答疑，辅导有针对性</el-radio>
                  </el-tag>
                </div>
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.six_score" label="C">C.能够对学生进行答疑辅导</el-radio>
                  </el-tag>
                </div>
                <div style="width: 100%">
                  <el-tag style="background-color: white;width: auto">
                    <el-radio v-model="form.six_score" label="D">D.很少答疑辅导，缺少耐心</el-radio>
                  </el-tag>
                </div>
  ...
  <!--</span>-->
      ...
      <toast v-model="toastsee" text="提交成功！"></toast>
    </div>
    <div style="float: left">
      <!--<el-button type="primary" size="small" @click="dialogVisible = true">点击评价</el-button>-->
      <el-dialog
      ...
      <alert v-model="gymShow" content="请选择体育老师"></alert>
    </div>
